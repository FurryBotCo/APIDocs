---
description: Get a random lick image!
---

# Lick

{% api-method method="get" host="https://api.furrybot.me/sfw" path="/lick/:responseType/:imageType" %}
{% api-method-summary %}
Get a lick.
{% endapi-method-summary %}

{% api-method-description %}
This endpoint allows you to get random fur licking images.
